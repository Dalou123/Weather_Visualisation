...
def get_temps(weather_dict: dict, value: str):
    """
    ...
    :param str  value: the name of the weather data to be extracted
    ...
    for i, v in enumerate(weather_dict['time']):
        if v.endswith("01"):
            ...
            data.append(weather_dict[value][i])
...
ax.set_title("Temperature on the 1st of each month from 1970 to 2023",
